...
unsigned int nStakeMaxAge = 60 * 60 * 24 * 365;  // 365 days
...
const string strMessageMagic = "TotalCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TotalCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (fTestNet)
    {
        ...
        bnTrustedModulus.SetHex("044589be521e21fbe25803ba6abd9d88f3f8c48fd5f4c2bad94920e1d08db25586accca4810f8329a7f90c26278c961263b578be7e09ed0b19dc0ce491b2e81afa");
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "TOTAL COIN - TOT";
        CTransaction txNew;
        txNew.nTime = 1457041500;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
		...
		//// debug print
        assert(block.hashMerkleRoot == uint256("0x96b15b445b04aea3290953188f4098285188e0b4f5e7a39b2c966df476968d0a"));
		block.print();
...
unsigned char pchMessageStart[4] = { 0xa1, 0xf2, 0xf8, 0xa6 };
